...
//        {
//            // Arrange
//            var venta = new Venta { IdVenta = 1, FechaVenta = DateTime.Now };
//            List<LineaDeVenta> lineadeventas = new List<LineaDeVenta>();
//            var lineaDeVenta1 = new LineaDeVenta { IdLineaDeVenta = 1, IdVenta = 1, Cantidad = 1 };
//            var lineaDeVenta2 = new LineaDeVenta { IdLineaDeVenta = 2, IdVenta = 1, Cantidad = 1 };
//            var art1 = new Articulo { IdCodigo = 1, Costo = 1000, MargenDeGanacia = 15, PorcentajeIVA = 0.21f }; //1391.5
//            var art2 = new Articulo { IdCodigo = 2, Costo = 2000, MargenDeGanacia = 15, PorcentajeIVA = 0.21f }; //2783
...
//        {
//            // Arrange
//            var art1 = new Articulo { IdCodigo = 1, Descripcion="Remera",Costo = 1000, MargenDeGanacia = 15, PorcentajeIVA = 0.21f }; //1391.5
...
//            var venta = new Venta { IdVenta = 1 };
//            var lineaDeVenta = new LineaDeVenta { IdLineaDeVenta = 1, IdVenta = 1, IdArticulo = 1, Cantidad = 3 };
...
//        public ServicioStockMock(List<Stock> listaStock)
//        {
//            _listaStock = listaStock;
//        }

//        public void ActualizarStockAlAgregarVenta(Venta venta, LineaDeVenta lineaDeVenta)
//        {
