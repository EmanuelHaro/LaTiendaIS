...
namespace LaTiendaIS.Server.Controllers
{
    ...
    [ApiController]
    public class PagoConEfectivoController : ControllerBase
    {
        private readonly IPagoEfectivoServicio _pagoServicio;

        public PagoConEfectivoController(IPagoEfectivoServicio pagoServicio)
        {
        ...
        [HttpPost]
        public async Task<ActionResult> AgregarPago(PagoEfectivo Pago)
        {
